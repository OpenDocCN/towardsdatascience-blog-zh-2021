...
![](img/78b12d7535fd3d076281853c1e328368.png)

公民数据科学家改变组织的工作方式——来自 [Pexels](https://www.pexels.com/photo/focused-muslim-woman-freelancer-working-on-laptop-on-street-6084442/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 的凯拉·伯顿摄影。
...
公民数据科学家是指在统计和分析之外的**领域工作，但仍然创建或生成包含预测或说明性分析的模型的人。**
...
*   [数据流畅性:在 LinkedIn learning 上探索和描述数据](https://www.linkedin.com/learning/data-fluency-exploring-and-describing-data/gather-greater-insight-and-make-better-decisions-with-your-data?autoAdvance=true&autoSkip=false&autoplay=true&resume=true)；
*   【Tableau eLearning 的全民数据扫盲；
*   Coursera 上的[医疗保健数据素养](https://www.coursera.org/learn/healthcare-data-literacy)，以及；
*   [edX 的数据素养基础](https://www.edx.org/course/data-literacy-foundations)。

## 为工作选择合适的工具。

要成为一名成功的公民数据科学家，您需要学习数据科学家工具的基础知识。

**基本编程技能**很重要，因为它们可以帮助将非结构化或无组织的数据转换为结构化和连贯的数据集。但是很好地理解无代码平台是必不可少的，比如 [Tableau](https://www.tableau.com/) ， [KNIME](https://www.knime.com/) ，更不用说 [Excel](https://www.microsoft.com/en-us/microsoft-365/excel) 了。
...
还有各种数据科学虚拟竞赛可以参加。例如， [Kaggle](https://www.kaggle.com/) 为数据科学家提供了一个平台，让他们在现实世界数据集和奖金的挑战中竞争。
...
要成为一名成功的公民数据科学家，你不需要拥有数学或计算机科学的高等学位。相反，学会分析，学会用数据创造[引人注目的故事](https://medium.datadriveninvestor.com/why-should-we-begin-every-meeting-with-a-story-66f3735d372e)。
