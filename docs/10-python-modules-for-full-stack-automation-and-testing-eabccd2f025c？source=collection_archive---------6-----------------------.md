...
![](img/25f8041888a1b4687ef7e3bb29313afd.png)
...
**官方文档:** [机器人框架](https://robotframework.org/)

# **2。PyTest**

它是不同语言中最流行的自动化框架之一。它非常简洁，因此可以专注于测试。你可以在使用这个平台的时候写一些其他的函数。它们被标记为 fixtures，可以用来使整个过程可重用和可伸缩。

**官方文档:** [PyTest](https://docs.pytest.org/en/6.2.x/)

**好文章:**[PyTest 综合指南](https://levelup.gitconnected.com/a-comprehensive-guide-to-pytest-3676f05df5a0)作者[理查德·施](https://medium.com/u/b959221b387?source=post_page-----eabccd2f025c--------------------------------)。
