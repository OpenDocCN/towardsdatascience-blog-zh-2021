...
![](img/ce8dc9f49c56ab4ecf1c00ca2dc119f5.png)

照片由 [Alwi Alaydrus](https://unsplash.com/@dodyalaydrus?utm_source=medium&utm_medium=referral) 在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄
...
为了理解这些复杂性，让我们使用这些度量来评估一个分类模型。我们将使用的数据来自 Kaggle 著名的 [*泰坦尼克号——从灾难中学习的机器*](https://www.kaggle.com/c/titanic/data) 分类比赛。数据集的每一行都描述了泰坦尼克号上的一名乘客。比赛的目的是利用提供的特征(如性别、年龄等。)来预测给定乘客是活着还是死了。

![](img/7ff9febfd0f5bcaca2cd35c943951b3c.png)
...
我们将使用数据集中的`Pclass`、`Sex`、`Age`、`SibSp`、`Parch`和`Fare`列来尝试和预测`Survived`，从而将逻辑回归模型拟合到我们的数据中。

![](img/3009728709257bd581a8cba271197cc6.png)

符合我们的模型，现在让我们产生我们的预测。

# 评估我们的模型

![](img/41732edc909081fdee3b893f2a9c759e.png)
...
现在我们有了一些预测，我们可以评估模型以确定它对实际类的预测有多好。理解我们模型准确性的一个关键是混淆矩阵。为了生成一个，我们将使用`caret`包中的`confusionMatrix`函数。该函数要求我们将输入作为因子提供，因此我们将进行转换并显示矩阵:

![](img/61b908651bdeb3d6dcf812dd25aff3f4.png)

在查看上面的结果时，我们可以看到我们的基线模型表现得不是很好。对角线上的值，从左上角到右下角，是模型准确预测的类。列标题表示实际类别，行标签表示预测类别。用视觉表示法来理解混淆矩阵通常更容易:

![](img/38b890ea264a3a1881f8299746ce7bae.png)
...
![](img/d15179c69267d2a8b2e1bbff8a5ef8ea.png)

由 [Ricardo Arce](https://unsplash.com/@jrarce?utm_source=medium&utm_medium=referral) 在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄

在我们将要讨论的所有指标中，准确性是最直接的，也是您可能最熟悉的。当涉及到分类模型时，准确性主要是一个高层次的抽查，几乎不应该是用来评估您的模型的唯一指标。可以使用混淆矩阵中的值计算准确度:

![](img/c2862e43468bc54f3c8412b40aaad6ad.png)
...
![](img/104b21a966fbb67a1e871e38081a99ef.png)

在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上 [NeONBRAND](https://unsplash.com/@neonbrand?utm_source=medium&utm_medium=referral) 拍摄的照片

这个度量是准确性的反义词。它向我们展示了我们的结果被错误分类的频率。其计算方法如下:

![](img/df9bb67392f753e489287fc7834b7cb7.png)

我们可以通过从 1 中减去我们的*准确性*度量来找到我们的模型的分类错误率。
...
![](img/d25d1f2584b20becd6a04e4eb239b543.png)

照片由[博夫肖](https://unsplash.com/@hikeshaw?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄
...
![](img/1a16a84fb0fb950f0519ed196fa27cde.png)
...
![](img/c470e1bb077da8b6e8cc6e95d9ce6189.png)
...
![](img/195fc37b6fe59b889aaa8c8893fdda68.png)
...
![](img/1c3fba52de8af6d26ef96d43e7b49dae.png)

由[乔希·弗雷内特](https://unsplash.com/@joshfrenette?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄的照片
...
![](img/b72d582690e651d20a9de36122670840.png)
