...
[](https://en.wikipedia.org/wiki/Nowcasting_%28meteorology%29) [## 临近预报(气象学)-维基百科

### 临近预报是根据世界气象组织发布的长达 2 小时的非常短期的中尺度天气预报

en.wikipedia.org](https://en.wikipedia.org/wiki/Nowcasting_%28meteorology%29) [](https://en.wikipedia.org/wiki/Time_series) [## 时间序列-维基百科

### 在数学中，时间序列是按时间顺序索引(或列出或绘制)的一系列数据点。最常见的是…

en.wikipedia.org](https://en.wikipedia.org/wiki/Time_series)  [## 可解释的人工智能-维基百科

### 可解释的人工智能(XAI)是一种人工智能，其解决方案的结果可以被人类理解…

en.wikipedia.org](https://en.wikipedia.org/wiki/Explainable_artificial_intelligence) [](https://en.wikipedia.org/wiki/Shapley_value) [## 沙普利价值-维基百科

### 沙普利值是合作博弈论中的一个解概念。它是为了纪念劳埃德·沙普利而命名的，他…

en.wikipedia.org](https://en.wikipedia.org/wiki/Shapley_value) [](https://enterprisersproject.com/article/2019/5/what-explainable-ai) [## 什么是可解释的人工智能？

### 人工智能不需要为围绕它的神话和误解提供任何额外的燃料。考虑一下…

enterprisersproject.com](https://enterprisersproject.com/article/2019/5/what-explainable-ai) [](http://aqua.upc.es/anywhere-catalogue-v2/?product=ravake-heavy-rainfall-nowcasting) [## 暴雨临近预报

### RAVAKE 将基于天气雷达的临近预报与各种…

aqua.upc.es](http://aqua.upc.es/anywhere-catalogue-v2/?product=ravake-heavy-rainfall-nowcasting) [](http://anywhere-h2020.eu/) [## 主页

### 任何地方项目:创新天气突发事件的管理观看更多视频在经合组织的任何地方项目…

anywhere-h2020.eu](http://anywhere-h2020.eu/) [](https://github.com/slundberg/shap) [## GitHub - slundberg/shap:一种解释任何机器学习输出的博弈论方法…

### SHAP 是一种博弈论的方法来解释任何机器学习模型的输出…

github.com](https://github.com/slundberg/shap) [](https://pytorch.org/) [## PyTorch

### 推动自然语言处理和多任务学习的发展。利用 PyTorch 的灵活性有效地研究新的…

pytorch.org](https://pytorch.org/) [](https://www.tensorflow.org/) [## 张量流

### 一个面向所有人的端到端开源机器学习平台。探索 TensorFlow 灵活的工具生态系统…

www.tensorflow.org](https://www.tensorflow.org/)  [## stats models . TSA . statespace . dynamic _ factor _ MQ。动态工厂模型

### 基于 EM 算法的动态因子模型:月度/季度数据选项。动态因素模型的实施…

www.statsmodels.org](https://www.statsmodels.org/stable/generated/statsmodels.tsa.statespace.dynamic_factor_mq.DynamicFactorMQ.html) [](https://hackerbits.com/data/expectation-maximization-em-data-mining-algorithm/) [## 普通英语中的期望最大化(EM)数据挖掘算法-黑客位

### EM 数据挖掘算法是一篇关于更多数据挖掘算法的文章的一部分。它是做什么的？在…

hackerbits.com](https://hackerbits.com/data/expectation-maximization-em-data-mining-algorithm/) [](https://jonathan-hui.medium.com/machine-learning-expectation-maximization-algorithm-em-2e954cb76959) [## 机器学习——期望最大化算法(EM)

### 鸡和蛋的问题是许多企业家最头疼的问题。许多机器学习 ML 问题处理一个…

jonathan-hui.medium.com](https://jonathan-hui.medium.com/machine-learning-expectation-maximization-algorithm-em-2e954cb76959)