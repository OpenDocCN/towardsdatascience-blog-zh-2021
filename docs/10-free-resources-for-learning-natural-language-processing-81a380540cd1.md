...
莱昂纳多·大久保俊郎在 [Unsplash](https://unsplash.com/s/photos/language?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上的照片
...
课程的所有幻灯片、视频、课堂讲稿和作业也可以在这个 [github repo](https://github.com/khanhnamle1994/natural-language-processing) 中找到。
