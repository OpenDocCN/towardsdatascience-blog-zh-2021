...
> 原文：<https://towardsdatascience.com/mlops-for-research-teams-9d58ee8759f5?source=collection_archive---------31----------------------->

## 确保您团队的工作是可重复的、负责任的、协作的和连续的

![](img/182b795dd3e9387dd2a5fe2f3a35cc62.png)
...
![](img/f8923455d6e00853b3a579e46f6369e1.png)

算法代码只是任何机器学习解决方案的一小部分。来源:作者——受[启发机器学习系统中隐藏的技术债务](https://papers.nips.cc/paper/2015/file/86df7dcfd896fcaf2674f757a2463eba-Paper.pdf)。
...
![](img/0f7db8b5d81def7325238b4ab3901a87.png)
...
![](img/133fc8bdd43b4ee43fb29abbf3c4504e.png)
...
虽然一些研究团队仍然没有 MLOps 工具或最佳实践，但我们相信 MLOps 已经成为几乎所有团队的重要组成部分。除非你的团队非常小或者只致力于琐碎的问题，否则你的机器学习研究也需要**可重复、可问责、协作、**和**持续。**如果没有 MLOps，实现这些目标将非常困难。

# 您需要帮助在您的研究团队中设置 MLOps 吗？

我们喜欢为机器学习研究团队找到合适的 MLOps 架构。[联系我们](https://datarevenue.com/en-contact)了解更多信息。