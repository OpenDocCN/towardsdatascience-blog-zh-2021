...
> 原文：<https://towardsdatascience.com/the-5-certificate-to-prove-your-python-knowledge-level-c1b3b74e6d6b?source=collection_archive---------2----------------------->

## 有时候，拥有一个证书可能是你需要的验证

![](img/87e00ec33d8cfe3c917f318187383f5c.png)

照片由 [Pexels](https://www.pexels.com/photo/happy-birthday-greeting-card-on-pink-surface-8177932/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 的 [Olya Kobruseva](https://www.pexels.com/@olyakobruseva?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 拍摄
...
也许最重要和最受关注的 4 个 Python 证书是由 [Python 研究所提供的。这些证书涵盖三个不同层次的知识，初级，中级和高级。](https://pythoninstitute.org/)

## №1: [PCEP(认证入门级 Python 程序员)](https://pythoninstitute.org/certification/pcep-certification-entry-level/)
...
## №3:[pcpp 1(Python 编程 1 认证专家)](https://pythoninstitute.org/certification/pcpp-certification-professional/)
...
## №4:[pcpp 2(Python 编程 2 认证专家)](https://pythoninstitute.org/certification/pcpp-certification-professional/)
...
## №5: [微软 Python 认证考试(98–381)](https://docs.microsoft.com/en-us/learn/certifications/exams/98-381)
