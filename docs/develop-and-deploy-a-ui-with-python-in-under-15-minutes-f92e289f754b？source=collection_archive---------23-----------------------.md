...
[](https://github.com/mkhorasani/streamlit_ui) [## mkhorasani/streamlit_ui

### 用 Python 在 15 分钟内开发和部署一个 UI——mkhorasani/streamlit _ UI

github.com](https://github.com/mkhorasani/streamlit_ui) 
