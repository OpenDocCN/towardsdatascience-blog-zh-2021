...
![](img/870309e3a5b268721573b957d794c2ca.png)

图片由 [Kankanravee Kanyawath](https://pixabay.com/users/once1nueng-7520188/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=5544856) 来自 [Pixabay](https://pixabay.com/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=5544856)
...
![](img/c281258a28ebf16c21b589b565b030fa.png)

Image by [愚木混株 Cdd20](https://pixabay.com/users/cdd20-1193381/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=4057425) from [Pixabay](https://pixabay.com/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=4057425)
...
Python 中最流行的数据科学库之一是 Scikit-Learn (sklearn)。Sklearn 包含了近 200 种不同的模型或“[估算器](https://scikitlearnjl.readthedocs.io/en/latest/models/#:~:text=scikit%2Dlearn%20has%20on%20the,neural%20nets%2C%20...))”这只是一个数据科学库。此外，过多的深度学习模型架构、混合和集成以及模型的选择是压倒性的。更不用说可用于预处理数据和部署解决方案的所有技术，这两者都对整体成功有影响。
...
> 考虑一个好的基准，比如一个现有的过程、人为错误(人类每小时大约犯 3-6 个[错误](https://www.linkedin.com/pulse/human-factors-error-role-bad-luck-incident-graham-edkins#:~:text=So%20just%20how%20normal%20is,3%2D6%20errors%20per%20hour)，或者一个基线模型。
> 
