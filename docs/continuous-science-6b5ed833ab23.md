...
![](img/fcc26ba8eb428f5c7e387aabe0d51c0c.png)
...
[持续集成和持续交付(CI/CD)](https://continuousdelivery.com/) 是这些解决方案的顶峰，允许敏捷软件开发社区中的软件开发人员比以往更快、更安全地交付解决方案。
...
![](img/a44e781bc2f98c875cf3a89d54244caa.png)
...
在 Mass Dynamics，我见过托管服务器应用 CI/CD，详细说明如何在每次更改代码时运行和测试代码。通过这样做，我们能够*自动*获得我们的代码在任何时候都工作的信心。如果检查不是自动的，我们不可能保持它的健康。
...
![](img/a68031544b9e77e8a0eb69ed4e844543.png)
...
如果社区能够走到一起，就解决个别问题(如[蛋白质推理问题](https://academic.oup.com/bib/article/13/5/586/415393))的算法的通用格式和基准达成一致，那么合乎逻辑的下一步将是建立公共服务器，在所有提交的算法和数据集上执行这些基准。
...
一个类似的令人敬畏的概念的例子是 [Kaggle](https://www.kaggle.com/) ，这是一个数据科学竞赛平台，人们可以提交数据问题，并设置基准以与提交的答案进行比较。数据科学家通过提交不同算法的结果来竞争。
...
尤其是，将“[*”*](https://www.oecd.org/sti/inno/open-science.htm)开放科学作为解决可复制性危机的驱动力令人振奋。创建[公平数据](https://www.ands.org.au/working-with-data/fairdata)(可发现、可访问、可互操作和可重复使用)的努力正通过像本文这样的论文进入蛋白质组学这样的高科技领域，它清楚地表明了全球共同的善意和共同的愿望，即减少研究的竞争，加强合作。
...
![](img/3bf4813c885076da63948434be159d5f.png)
