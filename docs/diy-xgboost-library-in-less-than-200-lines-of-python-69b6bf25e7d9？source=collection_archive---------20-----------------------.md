...
[](https://amzn.to/3OMgEkR) [## 实用的渐变增强:深入探究 Python 中的渐变增强

### 这本书的梯度推进方法是为学生，学者，工程师和数据科学家谁希望…](https://amzn.to/3OMgEkR) 

XGBoost 可能是数据科学中使用最广泛的库之一。世界各地的许多数据科学家都在使用它。这是一种非常通用算法，可用于执行分类、回归以及置信区间，如本文[中的](/confidence-intervals-for-xgboost-cac2955a8fde)所示。但是有多少人真正理解它的基本原理呢？
