...
卡罗琳·克里斯汀在 [Unsplash](https://unsplash.com/s/photos/motivational-quotes?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上的照片
...
*   Python/ R — [Codecademy](https://www.codecademy.com) 、 [HackerRank](https://www.hackerrank.com) 和 [datacamp](https://www.datacamp.com)
*   SQL — [模式](https://mode.com/sql-tutorial/introduction-to-sql/)和[学习 SQL](https://learnsql.com)
*   统计数据— [可汗学院](https://www.khanacademy.org/math/statistics-probability)
*   数学—[HSE 大学数据科学专业的数学](https://www.coursera.org/specializations/mathematics-for-data-science#courses)
*   数据分析— [使用 Python 进行数据分析](https://www.coursera.org/learn/data-analysis-with-python)
*   机器学习— [Andrew NG 的 ML 课程](https://www.coursera.org/learn/machine-learning)、[密西根大学的应用数据科学](https://www.coursera.org/specializations/data-science-python)、 [IBM 数据科学](https://www.coursera.org/professional-certificates/ibm-data-science)
...
*   志愿加入像 [DataKind](https://www.datakind.org) 这样的组织
...
*   重要的是要有一个目标，并制定实现目标的计划。你对数据科学的热情只能让你达到一定的水平。它需要适当的计划和跟踪来达到你的目标
