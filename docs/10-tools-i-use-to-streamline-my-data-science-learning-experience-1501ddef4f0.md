...
![](img/1b2e3126a0819ec9a5de08baf7738c1f.png)

罗伯特·卡塔林奇亚在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上的照片
...
*   面向数据科学的 Python—初学者课程(学习 Python、Pandas、NumPy、Matplotlib) | [链接](https://www.youtube.com/watch?v=LHBE6Q9XlzI)
*   SQL 教程—初学者全数据库教程| [链接](https://www.youtube.com/watch?v=HXV3zeQKqGY)
*   Python 数据分析—初学者的完整课程(NumPy、Pandas、Matplotlib、Seaborn) | [链接](https://www.youtube.com/watch?v=r-uOLxNrNk8&list=PLWKjhJtqVAblQe2CCWqV4Zy3LY01Z8aF1&index=3)
*   程序员实用深度学习——fast . ai 和杰瑞米·霍华德全教程| [链接](https://www.youtube.com/watch?v=0oyCUWLL_fU&list=PLWKjhJtqVAblStefaz_YOVpDWqcRScc2s&index=3)
...
**每个人以前都听过对 [Jupyter Notebook](https://jupyter.org/) 的赞美，因此我将简要说明为什么它会成为我学习数据科学的首选工具:**
...
**我希望在我刚开始学习数据科学的时候，我对 [Kaggle 课程](https://www.kaggle.com/learn/overview)有更多的了解。**
...
**[TensorFlow](https://www.tensorflow.org/) 是由谷歌创建的开源匹配学习平台，使开发和训练机器学习模型变得非常容易。**
...
**[BigML](https://bigml.com/features) 是另一个用于自动化决策的机器学习平台。虽然 BigML 是一项付费服务，但可以为个人项目创建一个免费帐户，允许访问 BigML 的所有功能(唯一的缺点是，根据 BigML 执行时的繁忙程度，您的任务可能会排队)。**
...
**作为最古老的数据分析工具之一， [Excel](/excel-for-data-science-a82247670d7a) 是一款久经考验的可靠工具，可以轻松分析和可视化数据集。作为一个刚刚入门的数据科学新手，Excel 让我很容易开始数据操作和分析任务。**
...
**[Matplotlib](https://matplotlib.org/) 是我最喜欢的用于数据可视化的 Python 库之一。这个有用的小工具功能强大，可以轻松生成图表、直方图、条形图、散点图和许多其他可视化图形。**
