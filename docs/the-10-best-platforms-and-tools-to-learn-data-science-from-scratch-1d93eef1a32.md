...
> 原文：<https://towardsdatascience.com/the-10-best-platforms-and-tools-to-learn-data-science-from-scratch-1d93eef1a32?source=collection_archive---------1----------------------->

## 学习数据科学的精英中的精英(最后包括我推荐的循序渐进的方法)

![](img/0a1dd4958dac3b9647fd5ca5858bccb1.png)

照片由 [Poodar Chu](https://unsplash.com/@poodar?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 在 [Unsplash](https://unsplash.com/s/photos/graduate?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上拍摄
...
[面向数据科学的 Python 简介](https://www.datacamp.com/courses/intro-to-python-for-data-science)

[R 简介](https://www.datacamp.com/courses/free-introduction-to-r)

[SQL 简介](https://www.datacamp.com/courses/introduction-to-sql)

## 推荐课程(付费)

[中级 Python](https://www.datacamp.com/courses/intermediate-python)

[用熊猫进行数据操作](https://www.datacamp.com/courses/data-manipulation-with-pandas)
...
[法南街](https://fs.blog)是提高思维能力的好地方。它有许多文章专注于清晰的思维和提高决策技能。在数据科学中，做出正确的决策非常重要。从问题定义到最终解决方案，我们在整个项目中做出许多决策。所以，提高自己的决策能力很重要。
...
[Datacamp 的数据科学 Python 简介](https://www.datacamp.com/courses/intro-to-python-for-data-science)
...
*   如果你喜欢这篇文章，也对类似的文章感兴趣，[关注我 Medium](https://rsharankumar.medium.com/) 。成为[中级会员](https://rsharankumar.medium.com/membership)，访问数千篇与职业、金钱等相关的文章。
